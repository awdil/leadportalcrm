            ...
            <div class="panel">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <div class="panel-body" style="padding: 0px;">
                        ...
                        <form action="<?php echo base_url('Mod/createWIP/') . $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div style="padding-left: 25px; padding-right: 25px; padding-top: 0; padding-bottom: 0px ">
                                    ...
                                    <div class="row">
                                     ...
                                     <?php if ($_SESSION['adminData']['role_name'] == "Client" && $_SESSION['adminData']['company_id'] != "230"){ ?>
                                    <div class="col-md-12">
                                        <div class="form-group <?php echo (form_error('wiptouserCloser')) ? 'has-error' : ''; ?> ">
                                            <label class="control-label col-md-2" style="text-align: left;">Closer Name</label>
                                                <div class="col-md-10" style="">
                                                <select  name="wiptouserCloser" class="form-control" id="wiptouserCloser">
                                                    <option value="">Select Closer Name</option>
                                                    <?php foreach ($userClosers as $singleuser): ?>
                                                        <option <?php echo (set_value('wiptouserCloser') == $singleuser->id ) ? 'selected' : ''; ?> value="<?php echo $singleuser->id ?>"><?php echo $singleuser->userName; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            <?php echo (form_error('wiptouserCloser')) ? '<br>' . form_error('wiptouserCloser', "<b class='text-danger'>", '</b>') : ''; ?>
                                                </div>
                                        </div>
                                    </div>
                                    <?php }elseif($_SESSION['adminData']['company_id'] == "230"){?>
                                    
                                    <input type="hidden" name="wiptouserCloser" value='<?php echo $_SESSION['adminData']['user_id']; ?>'>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group <?php echo (form_error('agentName')) ? 'has-error' : ''; ?> ">
                                            <label class="control-label col-md-2" style="text-align: left;">Agent Name</label>
                                                <div class="col-md-10" style="">
                                                <select  name="agentName" class="select2-container form-control select2" id="agentName">
                                                    <option value="0">Select Agent Name</option>
                                                    <?php foreach ($userAgentslist as $singleagent): ?>
                                                        <option <?php echo (set_value('agentName') == $singleagent->id ) ? 'selected' : ''; ?> value="<?php echo $singleagent->userName ?>"><?php echo $singleagent->userName; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            <?php echo (form_error('agentName')) ? '<br>' . form_error('agentName', "<b class='text-danger'>", '</b>') : ''; ?>
                                                </div>
                                        </div>
                                    </div>

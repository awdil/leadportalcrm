<?php
   ...
   if($lead_campaign[0]->campaign_name == "CICA Claims"){
        ...
        $formName = "CICA Claims Form";
        $Name_Action   = base_url('Mod/updateCICALead');
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group <?php echo (form_error('applyingfor')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select name="applyingfor" class="form-control">
                                                            <option <?php echo $CI->checkSelected('applyingfor', @$leadData->ec_utillity, "I am applying because of a single incident"); ?> value="I am applying because of a single incident">I am applying because of a single incident</option>
                                                            <option <?php echo $CI->checkSelected('applyingfor', @$leadData->ec_utillity, "I am applying because of a period of abuse"); ?> value="I am applying because of a period of abuse">I am applying because of a period of abuse</option>
                                                            <option <?php echo $CI->checkSelected('applyingfor', @$leadData->ec_utillity, "I am applying because someone has died"); ?> value="I am applying because someone has died">I am applying because someone has died</option>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('ClientPolicyNumber')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <input type="text" name="ClientPolicyNumber" value="<?php echo (set_value('ClientPolicyNumber') || form_error('ClientPolicyNumber')) ? (set_value('ClientPolicyNumber')) : (@$leadData->client_policy_number); ?>" class="form-control" placeholder="If client is under 18, please provide full details of the person who has full parental access">
                                                ...
                                                <div class="form-group <?php echo (form_error('Whatwastheexactlocationoftheaccident')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select name="Whatwastheexactlocationoftheaccident" class="form-control">
                                                            <option <?php echo $CI->checkSelected('Whatwastheexactlocationoftheaccident', @$leadData->what_was_the_exact_location_of_the_accident, "Yes"); ?> value="Yes">Yes</option>
                                                            <option <?php echo $CI->checkSelected('Whatwastheexactlocationoftheaccident', @$leadData->what_was_the_exact_location_of_the_accident, "No"); ?> value="No">No</option>
                                                        </select>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('Whatwastheweatherlike')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-10" style="">
                                                        <textarea rows="5" style="resize: none" name="Whatwastheweatherlike" placeholder="Full Representatives Details (Our Details)" class="form-control"><?php echo (set_value('Whatwastheweatherlike') || form_error('Whatwastheweatherlike')) ? (set_value('Whatwastheweatherlike')) : (@$leadData->what_was_the_weather_like); ?></textarea>

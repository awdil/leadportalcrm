<?php
   ...
   if($lead_campaign[0]->campaign_name == "MIB Claims"){
        ...
        $Name_Action   = base_url('Mod/updateMIBCampaignLead');
                                            ...
                                            <div class="form-group <?php echo (form_error('comprehensiveInsurance')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <select class="form-control" name="comprehensiveInsurance" id="comprehensiveInsurance">
                                                            ...
                                                            <option  <?php echo $CI->checkSelected('comprehensiveInsurance', @$leadData->are_you_a_litigation_friend, "Yes"); ?> value="Yes">Yes</option>
                                                            <option  <?php echo $CI->checkSelected('comprehensiveInsurance', @$leadData->are_you_a_litigation_friend, "No"); ?> value="No">No</option>
                                                        </select>

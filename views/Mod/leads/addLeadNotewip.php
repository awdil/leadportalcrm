                ...
                <div class="row">
                    ...
                    <div class="col-md-6 hidden-xs">
                        <div style="text-align: right; margin-right: 15px ">
                            <a href="<?php echo base_url('Mod/viewLeadWIPwip/');
...
<?php endif; ?>                                                
                        ...
                        <form action="<?php echo base_url('Mod/createLeadNoteWIP') ?>" method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-top: 9%">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="white-box" style="padding: 0px 25px 25px 25px;">
                            ...
                            <div class="table-responsive">
                                <table id='leadNotesWIP' class="table table-striped table-bordered">                        
                                    <thead>
                                        <tr>

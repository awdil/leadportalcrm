                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group <?php echo (form_error('agentaddress')) ? 'has-error' : ''; ?> ">
                                       <label class="control-label col-md-12" style="text-align: left;">
                                           ...
                                           Agent Address</label> 
                                       <div class="col-md-12" style=""> <input type="text" class="form-control" placeholder="Enter Agent Last name" name="agentaddress" value="<?php echo (set_value('agentaddress') || form_error('agentaddress')) ? (set_value('agentaddress')) : (@$leadData->are_you_a_litigation_friend); ?>">  <?php echo (form_error('agentaddress')) ? '<br>' . form_error('agentaddress', "<b class='text-danger'>", '</b>') : ''; ?> </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                     ...
                                     <label class="control-label col-md-12" style="text-align: left;">
                                        ...
                                        <div class="col-md-12" style=""> 
                                            <select class="form-control" name="incomeBeforetheEnd"  >
                                                 <option value="">Are you expecting to receive more income before the end (5 April) of the above tax year ?</option>
                                  ...
                                  <div class="col-md-12">
                                      <div class="col-md-6">
                                        <div class="form-group <?php echo (form_error('TotalofOtherPensions')) ? 'has-error' : ''; ?> ">
                                           ...
                                           <div class="col-md-12" style=""> 
                                               <input class="form-control"  type="text" value="<?php echo (set_value('TotalofOtherPensions') || form_error('TotalofOtherPensions')) ? (set_value('TotalofOtherPensions')) : (@$leadData->passenger_2_position_in_car); ?>"> <?php echo (form_error('TotalofOtherPensions')) ? '<br>' . form_error('TotalofOtherPensions', "<b class='text-danger'>", '</b>') : ''; ?> 
                                            </div>
                                        </div>
                                     </div>
                                     <div class="col-md-6">
                                        ...
                                        <div class="form-group <?php echo (form_error('severelysightimpairedreg')) ? 'has-error' : ''; ?> ">
                                           <label class="control-label col-md-12" style="text-align: left;" style="text-align: left">
                                            <span class="label other">(9.1)</span>
                                                If you’re registered blind (severely sight impaired) with a local authority, or other register, check from following in the box
                                            </label> 
                                           <div class="col-md-12" style=""> 
                                               <select class="form-control" name="severelysightimpairedreg" >
                                                 <option value="">If you live in Scotland or Northern Ireland and you’re</option>
                                                 <option  <?php echo (set_value('severelysightimpairedreg') == "Yes") ? "selected" : ""; ?> value="by an eye specialist"> Are certified blind or severely sight impaired by an eye specialist</option>
                                                   <option  <?php echo (set_value('severelysightimpairedreg') == "Yes") ? "selected" : ""; ?> value="local authority"> Are on a local authority register of blind </option>
                                  ...
                                  <div class="col-md-12">
                                      <div class="col-md-6">
                                        <div class="form-group <?php echo (form_error('claimthefullallowance')) ? 'has-error' : ''; ?> ">
                                           ...
                                           <div class="col-md-12" style=""> <br>
                                               <input type="text" value="<?php echo (set_value('claimthefullallowance') || form_error('claimthefullallowance')) ? (set_value('claimthefullallowance')) : (@$leadData->ec_namekey); ?>" class="form-control" id="" placeholder="full nameEnter full name" name="claimthefullallowance">
                                        ...
                                        <div class="form-group <?php echo (form_error('minimumCoupleamount')) ? 'has-error' : ''; ?> ">
                                           <label class="control-label col-md-12" style="text-align: left;" style="text-align: left">
                                            <span class="label other">(10.2)</span>
                                                  If, as a couple, you’ve already asked us to give all of the minimum amount to your spouse  or civil partner</label> 
                                           <div class="col-md-12" style=""> 
                                        ...
                                        <div class="form-group <?php echo (form_error('AlreadyAgreedminimumCoupleamount')) ? 'has-error' : ''; ?> ">
                                           <label class="control-label col-md-12" style="text-align: left;" style="text-align: left">
                                            <span class="label other">(10.3)</span>
                                                  If you’ve already agreed that half of the minimum amount is to go to your spouse or  civil partner
                                            </label> 
                                           <div class="col-md-12" style=""> 
                                        ...
                                        <div class="form-group <?php echo (form_error('SendtheRepaymentTo')) ? 'has-error' : ''; ?> ">
                                           ...
                                           <div class="col-md-12" style=""> <br>
                                               <select class="form-control" name="SendtheRepaymentTo" >
                                                 <option value="">Please Make Sure </option>
                                        ...
                                        <div class="form-group <?php echo (form_error('NeedclaimforminFuture')) ? 'has-error' : ''; ?> ">
                                           ...
                                           <div class="col-md-12" style=""> 
                                               <select class="form-control" name="NeedclaimforminFuture" >
                                                 <option value="">Did you need a claim form in future</option>

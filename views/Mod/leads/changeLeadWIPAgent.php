...
<?php endif; ?>
                        ...
                        <form action="<?php echo base_url('Mod/updateLeadAgnet') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<?php endif; ?>
                                        ...
                                        <div class="form-group <?php echo (form_error('users')) ? 'has-error' : ''; ?>">
                                            <label class="control-label col-md-3">Select Agent Name<span style="color: red"> *</span></label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control select2" name="users">
                                                    ...
                                                    <option <?php // form_error('status') ? $_POST['status'] = 2 . 'selected' : ''; ?> value="">Select Agent </option>

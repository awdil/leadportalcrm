...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            ...
            <h4 class="page-title">Add Employment Lead</h4> </div>
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Employment Lead</li>
            </ol>
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel-heading" style="padding: 28px 0px 13px 30px">Employment Claim Form</div>
                    </div>
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <div class="panel-body" style="padding: 0px;">
                        ...
                        <form action="<?php echo base_url('Mod/createEmploymentLead/') . $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('DateofAccident')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <input name="DateofAccident" class="form-control"  value="<?php echo set_value('DateofAccident'); ?>" placeholder="Your save and return number">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('memorableword')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <input name="memorableword" class="form-control"  value="<?php echo set_value('memorableword'); ?>" placeholder="Create your memorable word">
                                                ...
                                                <div class="form-group <?php echo (form_error('Whatwastheexactlocationoftheaccident')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select name="Whatwastheexactlocationoftheaccident" class="form-control">
                                                            <option <?php echo (set_value('Whatwastheexactlocationoftheaccident') == "Yes") ? "selected" : ""; ?> value="Email">Email</option>
                                                            <option <?php echo (set_value('Whatwastheexactlocationoftheaccident') == "No") ? "selected" : ""; ?> value="Post">Post</option>
                                                        </select>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('Whatwastheweatherlike')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-10" style="">
                                                        <textarea rows="5" style="resize: none" name="Whatwastheweatherlike" placeholder="Give the name of your employer or the person or organisation you are claiming against (If you need to you can add more respondents at 2.5)" class="form-control"><?php echo set_value('Whatwastheweatherlike'); ?></textarea>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-12">
                                                    <div class="form-group <?php echo (form_error('passenger_1')) ? 'has-error' : ''; ?> ">
                                                        ...
                                                        <div class="col-md-12" style="">
                                                            <textarea rows="5" style="resize: none" name="passenger_1" class="form-control" placeholder="Respondent&#039;s Full Address"><?php echo set_value('passenger_1'); ?></textarea>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group <?php echo (form_error('passenger_1_position_in_car')) ? 'has-error' : ''; ?> ">
                                                        ...
                                                        <input name="passenger_1_position_in_car" class="form-control"  value="<?php echo set_value('passenger_1_position_in_car'); ?>" placeholder="Respondents Contact Number">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group <?php echo (form_error('deferYourApplication')) ? 'has-error' : ''; ?> ">
                                                        ...
                                                        <div class="col-md-12" style="">
                                                            <input name="deferYourApplication" class="form-control"  value="<?php echo set_value('deferYourApplication'); ?>" placeholder="If Yes, please give the Acas early conciliation certificate number.">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group <?php echo (form_error('passenger_1_date_of_birth')) ? 'has-error' : ''; ?> ">
                                                        ...
                                                        <div class="col-md-12" style="">
                                                            <input name="passenger_1_date_of_birth" class="form-control"  value="<?php echo set_value('passenger_1_date_of_birth'); ?>" placeholder="If you worked at a different address from the one you have given at 2.2 please give the full address)">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('OLPLONLY')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <textarea name="OLPLONLY" rows="5" style="resize: none" class="form-control" placeholder="5 If there are other respondents please tick this box and put their names and addresses here. )"><?php echo set_value('OLPLONLY'); ?></textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('TimeofAccident')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input name="TimeofAccident" class="form-control" value="<?php echo set_value('TimeofAccident'); ?>" placeholder="Please give the Acas early conciliation certificate number if you have one">                                                 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('MedNegOnly')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <textarea name="MedNegOnly" class="form-control" rows="5" style="resize: none" placeholder="Provide full details of respondent 3 and others if there are more "><?php echo set_value('MedNegOnly'); ?></textarea>
                                    ...
                                    <div class="col-md-12">    
                                        <div class="form-group <?php echo (form_error('DetailsofTheIncident')) ? 'has-error' : ''; ?> ">
                                            <label class="control-label col-md-12" style="text-align: left">If Yes, and you know the names of any other claimants, add them here. This will allow us to link your claim to other related claims.</label>
                                                <div class="col-md-12" style="">
                                                    <textarea name="DetailsofTheIncident" class="form-control" rows="5" style="resize: none" placeholder="If Yes, and you know the names of any other claimants, add them here. This will allow us to link your claim to other related claims."><?php echo set_value('DetailsofTheIncident'); ?></textarea>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group <?php echo (form_error('ClientStatusinAccident')) ? 'has-error' : ''; ?> ">
                                                ...
                                                <div class="col-md-12" style="">
                                                    <input name="ClientStatusinAccident" class="form-control"  value="<?php echo set_value('ClientStatusinAccident'); ?>" placeholder="When did your employment start?">
                                        ...
                                        <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('WasAccidentreportedorrecordedintheaccidentBook')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input name="WasAccidentreportedorrecordedintheaccidentBook" class="form-control"  value="<?php echo set_value('WasAccidentreportedorrecordedintheaccidentBook'); ?>" placeholder="If your employment has ended, when did it end?">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_2')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input class="form-control" placeholder="Enter" name="passenger_2"  value="<?php echo set_value('passenger_2'); ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_2_relationship')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input class="form-control" placeholder="Enter " name="passenger_2_relationship" value="<?php echo set_value('passenger_2_relationship'); ?>">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_3_relationship')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input class="form-control" placeholder="If Yes, how many weeks, or months’ notice did you work, or were you paid for?" name="passenger_3_relationship" id="passenger_3_relationship" value="<?php echo set_value('passenger_3_relationship'); ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_3_position_in_car')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        ...
                                                        <input name="passenger_3_position_in_car" class="form-control"  value="<?php echo set_value('passenger_3_position_in_car'); ?>" placeholder="">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_4_relationship')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input name="passenger_4_relationship" class="form-control"  value="<?php echo set_value('passenger_4_relationship'); ?>" placeholder="">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_4_date_of_birth')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input class="form-control" placeholder="Please say how much you are now earning (or will earn)" name="passenger_4_date_of_birth" value="<?php echo set_value('passenger_4_date_of_birth'); ?>">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_5_relationship')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input class="form-control" placeholder="I am making another type of claim which the Employment Tribunal can deal with. " name="passenger_5_relationship" value="<?php echo set_value('passenger_5_date_of_birth'); ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_5_date_of_birth')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        ...
                                                        <input class="form-control" placeholder="Enter" value="<?php echo set_value('passenger_5_date_of_birth'); ?>">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('passenger_6')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <textarea name="passenger_6" class="form-control" rows="5" style="resize: none" placeholder="What compensation or remedy are you seeking? If you are claiming financial compensation please give as much detail as you can about how much you are claiming and how you have calculated this sum. (Please note any figure stated below will be viewed as helpful information but it will not restrict what you can claim and you will be permitted to revise the sum claimed later. See the Guidance for further information about how you can calculate compensation). If you are seeking any other remedy from the Tribunal which you have not already identified please also state this below."><?php echo set_value('passenger_6'); ?></textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('DidyouseekMedicalAttention')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input name="DidyouseekMedicalAttention"  value="<?php echo set_value('DidyouseekMedicalAttention'); ?>"  class="form-control" placeholder="">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('fi_tax_of610')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <textarea rows="5" style="resize: none" name="fi_tax_of610" class="form-control" placeholder="Section 2 allows you to list up to three respondents. If there are any more respondents please provide their details here"><?php echo set_value('fi_tax_of610'); ?></textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group <?php echo (form_error('Additionalnotes')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-12" style="">
                                                        <input name="Additionalnotes"  value="<?php echo set_value('Additionalnotes'); ?>"  class="form-control" placeholder="What is your ethnic group?">

<?php
   ...
   /* echo "<pre>";
    ...
    if ($lead_campaign[0]->campaign_name == "Car Hire"){
        ...
        $clone_Action   = base_url('Mod/updateLeadswip'); 
    }
...
<!--                        <p style="font-weight: 600; color: #313131"><i class="fa fa-arrow-down" style="font-size: 10px"></i> Contact Details</p>
                        ...
                        <form action="<?php echo base_url('Mod/updateLeadswip') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">

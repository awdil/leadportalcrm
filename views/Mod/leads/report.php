            ...
            <div class="panel">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="<?php echo base_url('Mod/report') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group" id="selt-company">
                                                    <div class="col-md-12" style="">
                                                        
                                                        <select class="form-control select2" name="company" id="company_id">
                                                            <option value="">Select Campaign</option>
                                                            
                                                            <option <?php echo ( set_value('company') == "All") ? 'selected' : ''  ?> value="All">All</option>
                                                            <?php if($companies): ?>
                                                                <?php foreach ($companies as $company): ?>
                                                            <option <?php echo ($company->id == set_value('company')) ? 'selected' : ''  ?> value="<?php echo $company->id; ?>"><?php echo ucfirst($company->company_name); ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group" id="sel-user_type">
                                                    <div class="col-md-12" style="">
                                                        
                                                        <select class="form-control select2" name="user_type" id="user_type">
                                                            <option value="">Select User Type</option>
                                                            <option <?php echo ( set_value('user_type') == "All") ? 'selected' : '' ?> value="All">All</option>                                                            
                                                            <?php if(isset($userType)): ?>
                                                                <?php foreach ($userType as $type): ?>
                                                                    <option <?php echo ($type->role_id == set_value('user_type')) ? 'selected' : ''  ?> value="<?php echo $type->role_id; ?>"><?php echo ucfirst($type->role_name); ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select>
                                                ...
                                                <div class="form-group" id="sel-user">
                                                    <div class="col-md-12" style="">
                                                        ...
                                                        <select class="form-control select2" name="user" id="user">
                                                            ...
                                                            <option <?php echo ($user->id == set_value('user')) ? 'selected' : ''  ?> value="<?php echo $user->id; ?>"><?php echo ucfirst($user->full_name); ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12" style="text-align: center; padding: 0px 10px 10px 10px">
                                                <button type="button" id="submit" class="btn btn-info col-md-2">SUBMIT</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="panel">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 style="padding: 17px 0px 0px 28px"><b>USERS LEADS DETAIL REPORT</b></h3>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div style="text-align: right; margin-right: 15px ">
                                    <a href="<?php echo base_url('Mod/downloadReport/' . 
                                            ...
                                            ) ?>" style="margin-top: 20px" class="btn btn-info" ><i class="fa "></i> Download Report Data</a>
                                </div>
                            </div>
                        ...
                        <div class="white-box" style="padding: 0px 25px 25px 25px;">
                            ...
                            <div class="table-responsive">
                                <table id='report' class="table table-striped table-bordered">                        
                                    ...
                                    <tbody>
                                        <?php if (!empty($leadReport)): ?>    
                                        <?php $i = 1; foreach ($leadReport as $report): ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>

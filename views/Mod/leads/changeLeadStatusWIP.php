...
<!--                        <p style="font-weight: 600; color: #313131">Lead Details</p>
                        ...
                        <form action="<?php echo base_url('Mod/updateChangeLeadStatuswip') ?>" method="post" enctype="multipart/form-data" class="form-changeleads-status">
...
<?php }else{ ?>
    <div class="row bg-title">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-9">
                <h4 class="page-title">Not Allowed to Change Lead Status</h4>
            </div>
        </div>
    </div>
<?php } ?>

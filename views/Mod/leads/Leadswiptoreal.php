<?php
  ...
  $getCompanyID   = $this->Mods->getIdByName($table_name = "users", $condition = "id", $data = @$leadData->user_id);
...
if (isset($_SESSION['Errors'])) {
   ...
   /* echo "<pre>";
    ...
    if ($lead_campaign[0]->campaign_name == "Car Hire"){
        ...
        $clone_Action   = base_url('Mod/createCHfromwip/') . $leadData->lead_id;  
    ...
    elseif($lead_campaign[0]->campaign_name == "Personal Injury"){
        ...
        $clone_Action   = base_url('Mod/createLeadfromwip/')  . $leadData->lead_id;  
    ...
    elseif($lead_campaign[0]->campaign_name == "Housing Disrepair"){
        ...
        $clone_Action   = base_url('Mod/createHDRfromwip/') . $leadData->lead_id; 
...
<?php $CI = & get_instance(); 
if($leadData->isStatusChangeLocked == 0){
?>
...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            ...
            <h4 class="page-title">Add Into Mature Lead</h4> </div>
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> Mature Lead</li>
            </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 hidden-xs">
                        <div style="text-align: right; margin-right: 15px ">
                            <a href="<?php echo base_url('Mod/manageWIP'); ?>" style="margin-top: 20px" class="btn btn-info btn-rounded"><i class="fa "></i> Manage Leads</a>
                        </div>
                    </div>
...
<!--                        <p style="font-weight: 600; color: #313131"><i class="fa fa-arrow-down" style="font-size: 10px"></i> Contact Details</p>
                        ...
                        <form action="<?php echo $clone_Action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                           <input type="hidden" name="leadstatusId" value="<?php echo (@$leadData->lead_status); ?>">
...
<?php endif; ?>                                            
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('firstName')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <input type="text" class="form-control" placeholder="Enter First Name" name="firstName" value="<?php echo (set_value('firstName') || form_error('firstName')) ? (set_value('firstName')) : (@$leadData->first_name); ?>">
                                                        <input type="hidden" name="leadId" value="<?php echo (@$leadData->lead_id) ? base64_encode(@$leadData->lead_id) : ''; ?>">                                               <input type="hidden" name="wipleadId" value="<?php echo (@$leadData->lead_id); ?> ">                                                     
                                                        <?php echo (form_error('firstName')) ? '<br>' . form_error('firstName', "<b class='text-danger'>", '</b>') : ''; ?>  
                                                    </div>
                                                </div>
                                            </div>
...
<?php endif; ?>                
                            ...
                            <div class="form-actions">
    <input type="hidden" name="leadUid" value="<?php echo (@$leadData->user_id) ? base64_encode(@$leadData->user_id) : ''; ?>">
    <input type="hidden" name="leadCid" value="<?php echo (@$leadData->company_id) ? base64_encode(@$leadData->company_id) : ''; ?>">
    <input type="hidden" name="leadAName" value="<?php echo (@$leadData->agent_name) ? base64_encode(@$leadData->agent_name) : ''; ?>">
    <input type="hidden" name="leadCamid" value="<?php echo ($lead_campaign[0]->campaign_id) ? base64_encode($lead_campaign[0]->campaign_id) : ''; ?>"><input type="hidden" name="leadComSN" value="<?php echo ($lead_campaign[0]->campaign_short_name) ? base64_encode($lead_campaign[0]->campaign_short_name) : ''; ?>">
                                
    <input type="hidden" name="Cid" value="<?php echo ($companyId) ? base64_encode($companyId) : ''; ?>">
    <input type="hidden" name="CName" value="<?php echo ($companyName) ? base64_encode($companyName) : ''; ?>">
    <input type="hidden" name="BdmName" value="<?php echo ($BDMName) ? base64_encode($BDMName) : ''; ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
...
<?php }else{ ?>
    <div class="row bg-title">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-9">
                <h4 class="page-title">Not Allowed to Change Lead </h4>
            </div>
        </div>
    </div>
<?php } ?>

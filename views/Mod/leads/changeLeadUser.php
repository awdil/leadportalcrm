...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Change Lead User</h4> 
        </div>
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Change Lead User</li>
            </ol>
        </div>
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel-heading" style="padding: 28px 0px 13px 30px">Change Lead User</div>
                    </div>
...
<?php endif; ?>
                        ...
                        <form action="<?php echo base_url('Mod/updateLeadUser') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            
                            <div class="form-body">
                                
                                <div class="col-md-12" style="padding: 0px; margin-top: 10px">
                                    <div class="alert alert-primary" style=" background-color: #2cabe3">                            
                                        <p style="font-weight: 500; color: #fff; font-size: 17px;"><i class="fa fa-arrow-down" style="font-size: 13px"></i> Change Lead User</p>
                                        <hr style="width: 100%; float: left; margin-top: 0px; border-color: rgba(247, 246, 240, 1)">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-11">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="text-align: Left; left: 10%; margin-top: -26px; margin-bottom: 19px">
                                                <button type="submit" class="btn btn-info">Change User</button>
                                            </div>

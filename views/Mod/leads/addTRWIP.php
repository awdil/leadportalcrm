            ...
            <div class="panel">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    ...
                    <div class="panel-body" style="padding: 0px;">
                        ...
                        <form action="<?php echo base_url('Mod/createTRWIP/') . $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" class="form-horizontal"> 
                        <div class="form-body">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group <?php echo (form_error('agentaddress')) ? 'has-error' : ''; ?> ">
                                       <label class="control-label col-md-12" style="text-align: left;">
                                           ...
                                           Agent Address</label> 
                                       <div class="col-md-12" style=""> <input type="text" class="form-control" placeholder="Enter Agent Last name" name="agentaddress" value="<?php echo set_value('agentaddress'); ?>"> <?php echo (form_error('agentaddress')) ? '<br>' . form_error('agentaddress', "<b class='text-danger'>", '</b>') : ''; ?> </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                  ...
                                  <div class="col-md-12">
                                      <div class="col-md-6">
                                        <div class="form-group <?php echo (form_error('GiftAidPaymentsClaimYear')) ? 'has-error' : ''; ?> ">
                                           ...
                                           <div class="col-md-12" style=""> 
                                               <input type="text" value="<?php echo set_value('GiftAidPaymentsClaimYear'); ?>" class="form-control" id="GiftAidPaymentsClaimYear" placeholder="Enter Amunt" name="GiftAidPaymentsClaimYear"> <?php echo (form_error('GiftAidPaymentsClaimYear')) ? '<br>' . form_error('GiftAidPaymentsClaimYear', "<b class='text-danger'>", '</b>') : ''; ?> 
                                            </div>
                                        </div>
                                     </div>
                                     <div class="col-md-6">
                                  ...
                                  <div class="col-md-12">
                                      <div class="col-md-6">
                                        <div class="form-group <?php echo (form_error('claimthefullallowance')) ? 'has-error' : ''; ?> ">
                                           ...
                                           <div class="col-md-12" style=""> <br>
                                               <input type="text" value="<?php echo set_value('claimthefullallowance'); ?>" class="form-control" id="" placeholder="full nameEnter full name" name="claimthefullallowance">

...
die();*/
 ...
 $formName       = "";
    ...
    if ($lead_campaign[0]->campaign_name == "Solicitor"){
        
        $formName       = "Solicitors Form";
        $clone_Action   = base_url('Mod/createSolicitor/') . $lead_campaign[0]->campaign_short_name; 
...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Clone Solicitor </h4> </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Dashboard</a></li>
                <li><a href="#">Solicitors </a></li>
                <li class="active">Clone Solicitor </li>
            </ol>
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel-heading" style="padding: 28px 0px 13px 30px">CLONE SOLICITOR </div>
                    </div>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group <?php echo (form_error('PartnerType')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select class="form-control" name="PartnerType" id="PartnerType">
                                                            ...
                                                            <option  <?php echo (set_value('PartnerType') == "CrClone Hire Company") ? "selected" : ""; ?> value="CrClone Hire Company">CrClone Hire Company</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('Rateagreedtominors')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <input type="text" class="form-control" placeholder="Rate agreed to minors" name="Rateagreedtominors" value="<?php echo (set_value('Rateagreedtominors') || form_error('Rateagreedtominors')) ? (set_value('Rateagreedtominors')) : (@$leadData->fi_eligble_tax_crClone); ?>">
                                    ...
                                    <div class="col-md-11">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="text-align: Left; left: 7%">
                                                <button type="submit" class="btn btn-info">Clone Solicitor </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

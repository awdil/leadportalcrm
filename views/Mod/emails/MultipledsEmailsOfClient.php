...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Send Emails to Selected Clients</h4> </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Dashboard</a></li>
                <li><a href="#">Leads</a></li>
                <li class="active">Send Emails to Selected Clients</li>
            </ol>
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel-heading" style="padding: 28px 0px 13px 30px">Send Emails to Selected Clients</div>
                    </div>
...
<!--                        <p style="font-weight: 600; color: #313131">Lead Details</p>
                        ...
                        <form action="<?php echo base_url('Mod/SendMultilpleLeadEmailsToclients') ?>" method="post" enctype="multipart/form-data" class="form-changeleads-status">
...
<!--                                <p style="font-weight: 600; color: #313131">Change Lead Status</p>
                        ...
                        <div class="col-md-12" style="padding: 0px; margin-top: 10px">
                            <div class="alert alert-primary" style=" background-color: #2cabe3">                            
                            <p style="font-weight: 500; color: #fff; font-size: 17px;"><i class="fa fa-arrow-down" style="font-size: 13px"></i> Send To All</p>
                            <hr style="width: 100%; float: left; margin-top: 0px; border-color: rgba(247, 246, 240, 1)">
                            </div>
                        </div>
                                ...
                                <div class="row" style="margin-top: 40px">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group <?php echo (form_error('status')) ? 'has-error' : ''; ?>">
                                            <label class="control-label col-md-4">Sending emails to the above list<span style="color: red"> *</span></label>

<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Edit User Group </h4> </div>
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel-heading" style="padding: 28px 0px 13px 30px">Edit User Group</div>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group <?php echo (form_error('user_group_name')) ? 'has-error' : ''; ?> ">
                                            ...
                                            <div class="col-md-7" style="">
                                                ...
                                                <input type="hidden"  id="group_id" name="group_id" value="<?php echo base64_encode($id); ?>">
                                                   ...
                                                   <!-- <?php if ($users): ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            <option <?php echo $CI->checkSelected('users', @$userData->campaign_id[$inc], $data = $campaign->campaign_id); ?> value="<?php echo $campaign->campaign_id ?>"><?php echo $campaign->campaign_name; ?></option>
                                                        <?php 
                                    ...
                                    <div class="col-md-11">
                                        <div class="row">
                                            <div class="col-md-12" style="text-align: Left; left: 7%">
                                                <button type="submit" class="btn btn-info">Edit User Group</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

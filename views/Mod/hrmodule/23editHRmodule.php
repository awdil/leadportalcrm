                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('firstName')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        ...
                                                        <input type="hidden" name="hrId" value="<?php echo (@$humanresource->id) ? base64_encode(@$humanresource->id) : ''; ?>">                                                                                                    
                                                ...
                                                <div class="form-group <?php echo (form_error('contactphone')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select class="form-control" name="contactphone">
                                                            ...
                                                            <option <?php echo $CI->checkSelected('contactphone', @$humanresource->contact_phone, "Unknown"); ?> value="Unknown">Unknown</option>
                                                            <option <?php echo $CI->checkSelected('contactphone', @$humanresource->contact_phone, "Yes"); ?> value="Yes">Yes</option>
                                                            <option <?php echo $CI->checkSelected('contactphone', @$humanresource->contact_phone, "No"); ?> value="No">No</option>
                                                        </select>
                                                ...
                                                <div class="form-group <?php echo (form_error('contactsms')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select class="form-control" name="contactsms">
                                                            <option value="">Permission to SMS</option>
                                                            <option <?php echo $CI->checkSelected('contactsms', @$humanresource->contact_sms, "Unknown"); ?> value="Unknown">Unknown</option>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group <?php echo (form_error('contactemail')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select class="form-control" name="contactemail">
                                                            ...
                                                            <option <?php echo $CI->checkSelected('contactemail', @$humanresource->contact_email, "Unknown"); ?> value="Unknown">Unknown</option>
                                                ...
                                                <div class="form-group <?php echo (form_error('contactmail')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <select class="form-control" name="contactmail">
                                                            ...
                                                            <option  <?php echo $CI->checkSelected('contactmail', @$humanresource->contact_mail, "Unknown"); ?> value="Unknown">Unknown</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?php echo (form_error('preferred_date_to_call')) ? 'has-error' : ''; ?> ">
                                                    ...
                                                    <div class="col-md-8" style="">
                                                        <input class="form-control" placeholder="Enter Preferred date to call" value="<?php echo (set_value('preferred_date_to_call') || $CI->CheckEmpty('preferred_date_to_call')) ? (set_value('preferred_date_to_call')) : @$humanresource->preferred_date_to_call; ?>" name="preferred_date_to_call" id="preferred_date_to_call">
